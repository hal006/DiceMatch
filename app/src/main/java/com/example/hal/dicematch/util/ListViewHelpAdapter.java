...
public class ListViewHelpAdapter extends ArrayAdapter<HashMap<String, String>> {
    ...
    public ListViewHelpAdapter(Context context, ArrayList<HashMap<String, String>> list) {
